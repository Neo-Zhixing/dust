...
fn main() {
    ...
    for &shader_file_path in &GLSL_ENTRY_FILES {
        ...
        out_path.set_extension(match stage {
            ...
            ShaderKind::RayGeneration => "rgen.spv",
            ShaderKind::ClosestHit => "rchit.spv",
            ShaderKind::AnyHit => "rahit.spv",
            ShaderKind::Intersection => "rint.spv",
            ShaderKind::Miss => "rmiss.spv",
            _ => unreachable!(),
        });
